...
/*
 * Yeah, i know, this is a bad way.
 * But this is only a sample project for a universtity exam.
 * If you want to use this product in production, please remove
 * this comments here. This script must be only accessible from localhost.
 *
